...
Stability fixes based on the published v1.4.24-d release and sing-box 1.14.1.
...
The whole-app lint check is not clean. Remaining findings include older-Android compatibility in local tethering, intentional hidden API use, and dependency/style warnings treated as errors. This release is not a claim that every app feature or supported Android version has been validated.

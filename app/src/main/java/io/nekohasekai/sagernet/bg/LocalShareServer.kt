...
class LocalShareServer(private val upstreamPort: Int) {
    ...
    companion object {
        ...
        // 20 was low enough that a single connection-heavy page (e.g. one
        // opening dozens of subdomains at once, like browserleaks.com)
        // could exceed it - anything past the cap was accepted then
        // immediately closed with no SOCKS response, which any client sees
        // as a refused/reset connection.

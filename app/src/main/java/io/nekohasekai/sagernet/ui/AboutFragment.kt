                            ...
                            MaterialAboutActionItem.Builder()
                                ...
                                .setOnClickAction {
                                    requireContext().launchCustomTab(
                                        "https://github.com/alaaabd90/vload/releases"
                                    )
                                }
                                .build())
                        .addItem(
            ...
            runOnIoDispatcher {
                try {
                    ...
                    val response = client.newRequest().apply {
                        if (checkPreview) {
                            setURL("https://api.github.com/repos/alaaabd90/vload/releases/tags/preview")
                        } else {
                            setURL("https://api.github.com/repos/alaaabd90/vload/releases/latest")
                        }
                    }.execute()
